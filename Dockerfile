...
RUN apt-get update && apt-get install -y git curl procps python3 poppler-utils python3-pil python3-docx python3-openpyxl make g++ cron tini && rm -rf /var/lib/apt/lists/*
